...
**Cost ceiling is structural, not monitored**: 300 messages/day global, 20/day per hashed IP, at most 200 Claude fallback calls/day, 512-token replies, last-12-messages context window. On the Gemini free tier the normal path is **$0/day**; the Claude fallback worst case is ≈ $1.40/day — and $0 if no key is configured.
